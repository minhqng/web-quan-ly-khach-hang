...
<form method="post" class="surface-card customer-form" data-customer-form data-customer-id="<?= e((string) $idKhachHang) ?>">
    ...
    <div class="form-section">
        <div class="form-section-title">
            ...
            <p>Định danh khách hàng và phân loại chăm sóc.</p>
        </div>
        <div class="row g-3">
            <div class="col-lg-6">
    ...
    <div class="form-section">
        <div class="form-section-title">
            <h3>Liên hệ</h3>
            <p>Số điện thoại hoặc email là bắt buộc để tránh hồ sơ rỗng.</p>
        </div>
        <div class="row g-3">
            <div class="col-md-6 col-lg-3">
    ...
    <div class="form-section">
        <div class="form-section-title">
            ...
            <p>Quyết định người phụ trách và trạng thái chăm sóc hiện tại.</p>
        </div>
        <div class="row g-3">
            <div class="col-md-6 col-lg-4">
    ...
    <div class="customer-form-actions form-actions">
